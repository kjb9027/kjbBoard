...
<body>
	<section class="section-login h-screen">
		<div class="container mx-auto h-full flex items-center justify-center">
			<!--  -->
			<form class="bg-white w-full shadow-md rounded px-8 pt-6 pb-8 md-4"
				...
				<div class="flex flex-col md-4 md:flex-row">
					...
					<div class="p-1 flex-grow">
						<input class="btn-primary bg-blue-500 hover:bg-blue-dark text-white font-bold py-2 px-4 rounded w-full" type="submit" value="로그인">
					</div>
				</div>
			</form>
		</div>
